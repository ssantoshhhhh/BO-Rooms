...
const CategoryPage = () => {
  ...
  const [showFilters, setShowFilters] = useState(false); // NEW: filter visibility
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-pink-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Total rooms found */}
        <div className="mb-4 text-lg font-semibold text-gray-800">Total rooms found: {rooms.length}</div>
        ...
        {/* Enhanced Filter Section (collapsible) */}
        {showFilters && (
          <div className="mb-8">
